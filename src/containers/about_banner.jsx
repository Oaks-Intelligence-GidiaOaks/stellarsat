...
const AboutBanner = ({ headerText, lead, image }) => {
  return (
    <section id="about-banner" className="min-h-[90vh] grid place-items-center">
      <div className="container py-10 flex flex-wrap items-center ">
        <div className="md:flex-[0.7] xs:flex-1  text-center mx-auto">
          <FadeReveal width="100%">
            <h3 className="text-3xl md:text-[58px] font-[500] mb-8 header-font">
              {headerText}
            </h3>
          </FadeReveal>
